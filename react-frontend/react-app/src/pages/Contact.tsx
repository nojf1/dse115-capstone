...
const branches: Contact[] = [
  { id: 1, name: "Suria KLCC", address: "Lot 403B, 4th Floor, Suria KLCC, 50088 Kuala Lumpur", phone: "03-2161 6788", state: "Kuala Lumpur", image: "https://via.placeholder.com/300" },
  { id: 2, name: "1 Utama Damansara", address: "Lot S-215, 2nd Floor, 1 Utama Shopping Centre, 47800 Petaling Jaya", phone: "03-7726 9988", state: "Selangor", image: "https://via.placeholder.com/300" },
  { id: 3, name: "Mid Valley Megamall", address: "Lot S-233, 2nd Floor, Mid Valley City, 59200 Kuala Lumpur", phone: "03-2283 8777", state: "Kuala Lumpur", image: "https://via.placeholder.com/300" },
        ...
        {filteredBranches.map((branch) => (
          <div key={branch.id} className="col-md-4 mb-4">
            <div className="card shadow">
              <img src={salonbg} alt={branch.name} className="card-img-top" /> {/* replace img src with branch.name later for specific images */} 
